...
def serialize(obj: Any, convert_key: Callable = lambda x: x) -> Any:
    """
    ...
    if isinstance(obj, Mapping):
        ...
        return {convert_key(k): serialize(v, convert_key) for k, v in obj.items()}
...
def deserialize(t, value, convert_key: Callable = lambda x: x) -> Any:
